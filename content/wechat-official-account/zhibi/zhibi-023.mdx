...
<details>
  ...
  <Carousel arrows infinite={false}>
    <CarouselInner>
      本题的蛇条件表明所有雷格是边连通的。 如果左下角想要边连通到右上角，则必须从蓝色或绿色区域穿过。 蓝色区域受制于 G7
      格的 4 无法穿过，故必有绿色区域的五格雷。
    ...
    <CarouselInner>
      继续考虑连通性。 如果蛇想要连通到 C7 格红色的 4 周围，要么穿过蓝色区域，要么经过 C5 和 D6 两个绿格。
      蓝色区域受制于 B6 的 3 无法穿过，故蛇必须经过绿格。 右上角同样考虑，就得到绿色的四格雷。
      <div className="lg:w-2/3">
    ...
    <CarouselInner>
      现在假设 F5 格不是雷，则由连通性，F6 格粉色的 3 右上方均是非雷格，左下方均是雷格，由蛇条件，此时 C7 的 4
      周围雷数不够，矛盾。 这表明 F5 格是雷。
      <div className="lg:w-2/3">
