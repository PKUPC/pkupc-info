...
<div className="lg:w-1/2 mx-auto">![](./zhibi-011.assets/zhibi-011-rule.webp)</div>
...
<AnswerCheck
  ...
  instructions={
    <markdown>
      依次输入从上到下<u>每一行</u>的空格数。对于多位数，只提交个位
    </markdown>
  }
/>
...
<Carousel arrows infinite={false}>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-1.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-2.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-3.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-4.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-5.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        ...
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-6.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-7.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        最后这题依赖于基础技巧即可解答。
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solA-8.webp').default} />
        </div>
    </CarouselInner>
...
<Carousel arrows infinite={false}>
    <CarouselInner>
        ...
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-1.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        而后的大致步骤如下：
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-2.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-3.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-4.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-5.webp').default} />
        </div>
    </CarouselInner>
    <CarouselInner>
        <div className="lg:w-2/3">
            <img src={require('./zhibi-011.assets/zhibi-011-solB-6.webp').default} />
        </div>
    </CarouselInner>
</Carousel>
</details>
