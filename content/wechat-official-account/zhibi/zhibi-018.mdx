...
今天是该系列的第二题。本题的规则为<span className="font-bold">[Q]无方</span>。
...
<Solution author={'怎苏昂'}>
  <div className="lg:w-2/3 mx-auto">![](./zhibi-018.assets/zhibi-018-sol.webp)</div>
</Solution>
...
<details>
  ...
  <Carousel arrows infinite={false}>
    <CarouselInner>
      本题的题眼在于图中所示的 363 三线索。 对于标注的每一个三格蓝色区域（D567/F567），不可以全部是雷（否则结合 C6/G6 的
      3 和无方规则会有矛盾）。 因此可以得到绿色叹号格子内的全部信息。
