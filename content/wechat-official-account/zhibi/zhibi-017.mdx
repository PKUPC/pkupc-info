...
<Solution author={'怎苏昂'}>
  <div className="lg:w-2/3 mx-auto">![](./zhibi-017.assets/zhibi-017-sol.webp)</div>
</Solution>
...
<details>
  ...
  <Carousel arrows infinite={false}>
    ...
    <CarouselInner>
      而后注意到下图中蓝色区域至少有一个雷（根据 E4 格的 3），黄色区域至少有一个雷（根据 G7 格的 5），结合 G5 格的
      2，所有带绿色感叹号的格子属性均可得出。
      <div className="lg:w-2/3">
    ...
    <CarouselInner>
      观察 A6 格的 2，蓝色区域内至多有两个雷。 观察 C6 格的 4，蓝色区域内至多两个雷。
      于是蓝色区域内必须恰好有两个雷，绿色叹号格子的属性可以得知。 （该推理方法可以被总结为扫雷的减法定式，在之前的
      <a href="/wechat-official-account/zhibi-010" target="_blank">彼岸双生的这篇文章</a>
      中的解析扫雷篇里有所提及）
      <div className="lg:w-2/3">
