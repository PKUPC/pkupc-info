...
不出意外的话，明年<span className="text-purple-700 font-bold">应该还会在 5-6 月有一次 puzzlehunt，应该会有网站，应该还是不出 30 题的体量，应该会比这次难，但依然会有充足的提示（甚至更充足）</span>，应该。再未来的事——虽然也可以构想很多，比如是一年两次还是一年一次——暂时还是不作构想了。
